...
# UPDATED: Removed DEFAULT_DEADTIME
...
usage() {
    ...
    # UPDATED: Removed -d PATH Deadtime CSV
...
# UPDATED: Removed 'd:' from getopts
while getopts "i:r:o:n:bvp:s:e:at:h" opt; do
    case $opt in
        i) RUN_INFO=$OPTARG ;;
        r) RATES=$OPTARG ;;
        o) OUTPUT_H5=$OPTARG ;;
...
# UPDATED: Removed --deadtime $DEADTIME from PY_ARGS
...
# Execute Python
python generate_quality_map_analyzer2.py $PY_ARGS
